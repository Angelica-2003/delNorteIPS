...
class tipoEcografia(models.Model):
    nombreTipoEcografia=models.TextField(max_length=45, verbose_name="Nombre Tipo de Ecografia")
    descripcion=models.TextField(max_length=45, verbose_name="Descripcion")
    preparacionEcografia=models.TextField(max_length=45, verbose_name="Preparacion Ecografia")
